class MetaPress_Product_Payments_Manager {
    ...
    verify_product_price(product_id, access_box, token_address) {
        ...
        if( product_id && metapress_metamask_loading_manager.currentMMAccount ) {
            ...
            metapress_verify_price_url = this.set_request_param(metapress_verify_price_url, 'mpwalletaddress', metapress_metamask_loading_manager.currentMMAccount);
    ...
    check_current_address_products_access(products) {
        if( products && jQuery.isArray(products) && metapress_metamask_loading_manager.currentMMAccount ) {
            ...
            metapress_check_access = this.set_request_param(metapress_check_access, 'mpwalletaddress', metapress_metamask_loading_manager.currentMMAccount);
    ...
    mark_transaction_as_paid(product_id, transaction_hash) {
        if( product_id && metapress_metamask_loading_manager.currentMMAccount ) {
            ...
            metapress_mark_as_paid = this.set_request_param(metapress_mark_as_paid, 'mpwalletaddress', metapress_metamask_loading_manager.currentMMAccount);
    ...
    remove_pending_transaction(product_id, transaction_hash) {
        ...
        if( product_id && metapress_metamask_loading_manager.currentMMAccount ) {
            ...
            metapress_delete_tx = this.set_request_param(metapress_delete_tx, 'mpwalletaddress', metapress_metamask_loading_manager.currentMMAccount);
