...
<html lang="en-US">
	...
	<title>Log In &lsaquo; Restaurant Blog &#8212; WordPress</title>
...
<link rel="stylesheet" id="login-css" href="/wp-admin/css/login.min.css?ver=6.0" type="text/css" media="all">
	...
	<script type="text/javascript">
		...
		<form name="loginform" id="loginform" action="httplocalhost:8012/wordpress-6.0/wordpress/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="httplocalhost:8012/wordpress-6.0/wordpress/wp-admin/">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }		</script>
				<p id="backtoblog">
			<a href="/">&larr; Go to Restaurant Blog</a>		</p>
			</div>
			<script type="text/javascript" src="/wp-includes/js/jquery/jquery.min.js?ver=3.6.0" id="jquery-core-js"></script>
<script type="text/javascript" src="/wp-includes/js/jquery/jquery-migrate.min.js?ver=3.3.2" id="jquery-migrate-js"></script>
<script type="text/javascript" id="zxcvbn-async-js-extra">
/*  */
var _zxcvbnSettings = {"src":"httplocalhost:8012\/wordpress-6.0\/wordpress\/wp-includes\/js\/zxcvbn.min.js"};
/*  */
</script>
...
/*  */
var _wpUtilSettings = {"ajax":{"url":"\/wordpress-6.0\/wordpress\/wp-admin\/admin-ajax.php"}};
/*  */
</script>
<script type="text/javascript" src="/wp-includes/js/wp-util.min.js?ver=6.0" id="wp-util-js"></script>
<script type="text/javascript" id="user-profile-js-extra">
/*  */
var userProfileL10n = {"user_id":"0","nonce":"eae6ee96b8"};
/*  */
</script>
